...
public class DonoView {
    ...
    private static void listarDonos() {
        ...
        if (donos.isEmpty()) {
            ...
            for (Dono dono : donos) {
                System.out.println("------------------------------------");
                System.out.println("ID: " + dono.getIdDono());
                System.out.println("Tipo: " + dono.getTipo());
                System.out.println("Nome: " + dono.getNome());
                System.out.println("Razão Social: " + dono.getRazaoSocial());
                System.out.println("CPF: " + dono.getCpf());
                System.out.println("CNPJ: " + dono.getCnpj());
                System.out.println("Email: " + dono.getEmail());
                System.out.println("Data de Nascimento: " + dono.getDataNascimento());
            }
        }
    }
}

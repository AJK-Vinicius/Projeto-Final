...
public class FuncionarioController {
    ...
    public static void adicionarFuncionario(Funcionario funcionario) {
        ...
        try (Connection conn = Database.getConnection();
            ...
            pstmt.setDate(5, convertStringToDate(funcionario.getDataNascimento()));
    ...
    public static void atualizarFuncionario(int id, Funcionario funcionario) {
        ...
        try (Connection conn = Database.getConnection();
            ...
            pstmt.setDate(4, convertStringToDate(funcionario.getDataNascimento()));
            pstmt.setInt(5, id);
    ...
    public static List<Funcionario> listarFuncionarios() {
        ...
        try (Connection conn = Database.getConnection();
            ...
            while (rs.next()) {
                ...
                funcionario.setDataNascimento(rs.getDate("DataNascimento").toString());
